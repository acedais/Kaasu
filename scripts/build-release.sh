...
function usage()
{
    ...
    echo "and generates the checksum files of the Kaasu tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/acedais/kaasu.git"
CLONE_DIR="$BUILD_DIRECTORY/kaasu-buildall"
TARGET_DIR="$BUILD_DIRECTORY/kaasu-releases"
DYNAMIC_RELEASE="kaasu-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="tkaasu-${TAG_VERSION}-linux-staticboost-CLI"
