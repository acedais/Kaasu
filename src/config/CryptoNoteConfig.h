...
// Copyright (c) 2018, The TurtleCoin Developers , The Acedais Developers
...
const uint32_t CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW          = 160;
const uint64_t CRYPTONOTE_BLOCK_FUTURE_TIME_LIMIT            = 60 * 60 * 2;
const uint64_t CRYPTONOTE_BLOCK_FUTURE_TIME_LIMIT_V3         = 60 * 60 * 2;
const uint64_t CRYPTONOTE_BLOCK_FUTURE_TIME_LIMIT_V4         = 60 * 60 * 2;

const size_t   BLOCKCHAIN_TIMESTAMP_CHECK_WINDOW             = 60;
const size_t   BLOCKCHAIN_TIMESTAMP_CHECK_WINDOW_V3          = 60;

// MONEY_SUPPLY - total number coins to be generated
const uint64_t MONEY_SUPPLY                                  = UINT64_C(1050000000000);
...
/* Premine amount */
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(840000000000);
const char     GENESIS_COINBASE_TX_HEX[]                     = "01a00101ff000180a09b9fb918029726f940fb03dcbe34c2164392883225b23446dd5569a01ec15c21a4c8237f6021018c4676fa08e95780b3f0072f3e43439b52de4c66d0d3263a4c986d31d33ca3c2";
static_assert(sizeof(GENESIS_COINBASE_TX_HEX)/sizeof(*GENESIS_COINBASE_TX_HEX) != 1, "GENESIS_COINBASE_TX_HEX must not be empty.");

/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in kaasud. It is used to know what timestamp
   to import from when the block height cannot be found in the node or the node is offline. */
const uint64_t GENESIS_BLOCK_TIMESTAMP                       = 1540676008;
...
const uint64_t DIFFICULTY_WINDOW_V3                          = EXPECTED_NUMBER_OF_BLOCKS_PER_DAY;
...
const char     CRYPTONOTE_NAME[]                             = "Kaasu";
...
const int      P2P_DEFAULT_PORT                              =  10177;
const int      RPC_DEFAULT_PORT                              =  10178;
const int      SERVICE_DEFAULT_PORT                          =  10179;
...
const char     LATEST_VERSION_URL[]                          = "https://getkaasu.com";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0x22 ,0x02, 0x19, 0x84 , 0x06, 0x11 , 0x20, 0x17, 0x07, 0x01, 0x20, 0x18, 0x06, 0x11, 0x20, 0x18  }
};

const char* const SEED_NODES[] = {
        "142.93.134.72:10111",
        "142.93.134.135:10111"
};
} // CryptoNote
