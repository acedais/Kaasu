...
// Copyright (c) 2018, The TurtleCoin Developers , The Acedais Developers // Copyright (c) 2018, The Acedais Developers // Please see the included LICENSE file for more information.
